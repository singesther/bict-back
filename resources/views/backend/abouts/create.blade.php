...
@section('content')
	<div class="row modify-row-margin">
		<div class="col-md-12">
			<h3>@lang('backend.add_new') - @lang('backend.about')</h3>
		<hr>
		</div>
	</div>
	<div class="row modify-row-margin">
		{!! Form::open(array('route' => 'abouts.store', 'data-parsley-validate' => '', 'files' => true)) !!}
		<div class="col-md-9">
			...
			{{ Form::text('slug', null, array('class' => 'slug form-control', 'id' => 'slug_input', 'required' => '', 'minlength' => '3',
				'maxlength' => '255')) }}
		...
		<div class="col-md-3">
            ...
            {{ Form::label('file_name', trans('backend.upload_image'), ['class' => 'form-spacing-top']) }}
			{{ Form::file('file_name', ['id' => 'jimage']) }}

			<img src="/images/default.png" class="about-img form-spacing-top" id="uploadedimage">
			<p>
