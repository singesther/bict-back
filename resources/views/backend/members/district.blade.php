          ...
          <tbody>
            @foreach ($users as $user)
              <tr>
                ...
                <td>
                  <a href="{{route('member.show', $user->id)}}" class="btn btn-success btn-sm" title="View"><span class="fa fa-eye"></span></a>
                  <a href="{{route('member.edit', $user->id)}}" class="btn btn-primary btn-sm" title="Edit"><span class="fa fa-pencil"></span></a>
                </td>
              </tr>
            @endforeach
          </tbody>
