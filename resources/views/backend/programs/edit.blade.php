...
<div class="row modify-row-margin">
  <div class="col-md-12">
    <h3>@lang('backend.edit') - program</h3>
  <hr>
  </div>
</div>
<div class="row modify-row-margin">
  {!! Form::model($program, ['route' => ['programs.update', $program->id], 'method' => 'PUT', 'files' => true]) !!}
    ...
    <div class="col-md-3">
        ...
        @if($program->file_name != '')
          <img class="program-img form-spacing-top" id="uploadedimage" src="{{ asset('images/programs/' . $program->file_name) }}">
        @else
          <img class="program-img form-spacing-top" id="uploadedimage" src="{{ asset('images/banner-hero.png') }}" width="100%" height= "100%">
        @endif
        ...
        <div class="row">
          <div class="col-sm-6">
            {!! Html::linkRoute('programs.show', trans('backend.cancel'), array($program->id), array('class' => 'btn btn-danger btn-block')) !!}
          </div>
          <div class="col-sm-6">
